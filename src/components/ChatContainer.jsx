...
const ChatContainer = () => {
  const { messages, setSelectedUser, selectedUser, sendMessages, getMessages } =
        ...
        {messages.map((message, index) => (
          ...
          >
            ...
            {message.image ? (
              ...
              <p
                className={`p-2 max-w-[200px] md:text-sm font-light rounded-lg mb-8 bg-[#212942] text-white ${
            ...
            <div className="text-center text-xs">
              <img
                src={
                  message.senderID === authUser._id ? authUser?.profilePic || assets.avatar_icon : selectedUser?.profilePic || assets.avatar_icon
                }
                alt=""
